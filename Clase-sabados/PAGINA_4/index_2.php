...
<body>
    <header>
        <div class="logo"><img src="./bom.png" alt=""></div>
        <div class="texto">
    ...
    <div class="formulario">
        ...
        <form action="" method="post">
            <table>
                ...
                <tr>
                    <td> Valor Energia</td>
                    <td> <input type="text" name="txtvalor" size="Go" placeholder="Valor Energia"></td>
                </tr>
    ...
    if(isset($_POST['calcular'])){
        ...
        echo("<br> * TIENE UN CONSUMO DE LUZ :: "  .$consumo. " NEWTON");
